...
class UtilityViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        loadDBModel.loadMonthlyUtilityTransition(groupID: groupID, year: year, settlementDay: settlementDay, startDate: startDate, endDate: endDate)
    }
    ...
    @objc func nextYear(_ sender: UIButton){
        ...
        loadDBModel.loadMonthlyUtilityTransition(groupID: groupID, year: nextYear, settlementDay: settlementDay, startDate: startDate, endDate: endDate)
    }
    ...
    @objc func lastYear(_ sender: UIButton){
        ...
        startDate = dateFormatter.date(from: "\(Int(year)! - 1 + yearCount)年\("12")月\(settlementDay)日")!
        endDate = dateFormatter.date(from: "\(Int(year)! + yearCount)年\("12")月\(settlementDay)日")!
        loadDBModel.loadMonthlyUtilityTransition(groupID: groupID, year: lastYear, settlementDay: settlementDay, startDate: startDate, endDate: endDate)
    }
...
// MARK: - LoadOKDelegate
extension UtilityViewController:LoadOKDelegate{
